...
with tempfile.TemporaryDirectory(prefix="homeserver-agent-tools-") as data_dir:
    ...
    with TestClient(app) as client:
        ...
        owner_sequence = [
            {
                ...
                "model": "llama-test",
                "content": "",
                "tool_calls": [tool_call("homeserver_knowledge_search", {"query": "merchant partnership", "limit": 3})],
            },
        ...
        app_sequence = [
            {
                ...
                "model": "llama-test",
                "content": "",
                "tool_calls": [tool_call("homeserver_memory_list", {"limit": 10})],
            },
        ...
        app_chat = client.post(
            "/api/v1/chat",
            json={"message": "Try to inspect memory."},
        ...
        budget_sequence = [
            {
                ...
                "content": "",
                "tool_calls": [
                    tool_call("homeserver_knowledge_search", {"query": "merchant"}),
                    tool_call("homeserver_memory_list", {"limit": 5}),
                ],
            },
        ...
        write_sequence = [
            {
                ...
                "model": "llama-test",
                "content": "",
                "tool_calls": [tool_call("homeserver_memory_write", {"content": "The model must not write this."})],
            },
