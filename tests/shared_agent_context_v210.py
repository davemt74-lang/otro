...
with tempfile.TemporaryDirectory(prefix="homeserver-shared-agent-") as data_dir:
    ...
    assert ping["payload"]["version"]=="2.1"
    ...
    assert exchanged["payload"]["version"]=="2.1"
...
print("HomeServer v2.1 shared Agent runtime exchange passed")
