...
def capabilities() -> dict:
    ...
    return {
        ...
        "work_continuity": {
            "version": "2.3",
            "authority": "vp3_cloud_job_engine",
            "receipt_store": "cloud_work_continuity",
            "operations": ["agent.chat", "work.continuity.status", "work.continuity.cancel"],
            "local_control_api": "/api/v1/control/work-continuity",
            "stable_key_scope": "cloud_run_action",
            "restart_recovery": True,
            "result_replay": True,
            "stale_running_recovery_seconds": 300,
        ...
        "features": [
            ...
            "work.continuity.v1",
            "work.continuity.result_replay.v1",
            "skills",
            "tasks.read",
            "tasks.write",
            "tasks.reminders",
